...
export default function CalendlyEmbed({ url }: { url: string }) {
  ...
  return (
    <div className="border-glow rounded-2xl overflow-hidden bg-white/[0.02] max-w-full">
      <iframe
        src={embedUrl}
        className="w-full max-w-full min-h-[700px] h-[700px] sm:min-h-[800px] sm:h-[800px]"
        frameBorder="0"
        allowFullScreen
